...
interface CreditCheckConfirmModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export const CreditCheckConfirmModal: React.FC<CreditCheckConfirmModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  project,
          ...
          <div className="bg-gray-50/50 border border-gray-100 rounded-xl p-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-12">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-gray-900">XXX建设局</span>
              </div>
            </div>
          </div>
